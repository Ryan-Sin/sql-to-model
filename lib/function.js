...
//기본 값 추출
function findDefaultValue(columnInfo, columnTypes) {
  if (columnInfo.split("DEFAULT")[1] !== undefined) {
    if (
      columnTypes === "datetime" ||
      columnTypes === "date" ||
      columnTypes === "time"
    ) {
      return "'" + columnInfo.split("DEFAULT")[1].split("COMMENT")[0] + "'";
    } else {
      return columnInfo.split("DEFAULT")[1].split("COMMENT")[0];
    }
  } else {
